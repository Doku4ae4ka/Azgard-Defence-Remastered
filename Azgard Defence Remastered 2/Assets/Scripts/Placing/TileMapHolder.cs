...
public class TileMapHolder : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        map.size = new Vector3Int(gridSize.x, gridSize.y, 0);
        //map.orientation;
        var screenOffSet = new Vector3(Screen.width * 0.5f, Screen.height * 0.5f, 0);
        ...
        for (int x = 0; x < map.size.x; x++)
        {
            for (int y = 0; y < map.size.y; y++)
            {
                ...
                var tilePosition = map.CellToWorld(coordinate) - screenOffSet;
